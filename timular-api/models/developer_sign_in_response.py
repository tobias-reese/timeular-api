...
class DeveloperSignInResponse(object):
    ...
    def __init__(self, token=None):  # noqa: E501
        """DeveloperSignInResponse - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def token(self):
        """Gets the token of this DeveloperSignInResponse.  # noqa: E501


        :return: The token of this DeveloperSignInResponse.  # noqa: E501
        :rtype: str
        """
        return self._token
    ...
    def token(self, token):
        """Sets the token of this DeveloperSignInResponse.


        :param token: The token of this DeveloperSignInResponse.  # noqa: E501
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DeveloperSignInResponse):
            return False

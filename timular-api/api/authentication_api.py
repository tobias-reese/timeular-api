...
class AuthenticationApi(object):
    ...
    def developer_sign_in(self, **kwargs):  # noqa: E501
        ...
        With this endpoint you can obtain Access Token required to access secured endpoints. To do so, you have to provide API Key & API Secret. They can be generated on [Profile website](https://profile.timeular.com/#/app/) or, if you have Access Token already, with `POST` request to `/developer/api-access`.  # noqa: E501
    ...
    def get_api_key_0(self, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.get_api_key_0(async=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async'):
            return self.get_api_key_0_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.get_api_key_0_with_http_info(**kwargs)  # noqa: E501
            return data

    def get_api_key_0_with_http_info(self, **kwargs):  # noqa: E501
        """Generate new API Key &amp; API Secret  # noqa: E501

        With this endpoint you can generate new pair of API Key & API Secret. Every time you generate a new pair, an old one becomes invalid. Your API Secret won't be accessible later, so please note it down in some secret place. If you have lost your API Secret, you can generate a new pair of API Key & API Secret here.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.get_api_key_0_with_http_info(async=True)
        >>> result = thread.get()

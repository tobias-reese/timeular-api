...
import timular-api
from timular-api.api.time_tracking__reports_api import TimeTrackingReportsApi  # noqa: E501
...
class TestTimeTrackingReportsApi(unittest.TestCase):
    ...
    def setUp(self):
        self.api = timular-api.api.time_tracking__reports_api.TimeTrackingReportsApi()  # noqa: E501

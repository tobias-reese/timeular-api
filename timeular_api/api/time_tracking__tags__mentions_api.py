...
class TimeTrackingTagsMentionsApi(object):
    ...
    def get_tags_and_mentions(self, **kwargs):  # noqa: E501
        ...
        if kwargs.get('async'):
            return self.get_tags_and_mentions_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.get_tags_and_mentions_with_http_info(**kwargs)  # noqa: E501
            return data

    def get_tags_and_mentions_with_http_info(self, **kwargs):  # noqa: E501
        """Fetch Tags &amp; Mentions  # noqa: E501

        Tags and Mentions are created with the use of an explicit reference  with the Notes of your Time Entries / Tracking. Moreover, if an Activity is linked with Integration, let's say JIRA Project, JIRA task IDs are visible as Tags. With this endpoint, you can fetch all Tags and Mentions valid in context. Referring to a context means that Mentions are system-wide and  Tags are either bound to an Integration or to the Timeular System.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.get_tags_and_mentions_with_http_info(async=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method get_tags_and_mentions" % key
                )
            params[key] = val
        del params['kwargs']
